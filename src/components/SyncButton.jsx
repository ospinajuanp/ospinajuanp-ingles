...
export default function SyncButton({ onClick, className = '' }) {
  ...
  return (
    <button
      ...
      className={`relative inline-flex items-center justify-center rounded-full border border-base-300 bg-base-100 p-2.5 text-base-content shadow-sm transition hover:border-primary/40 hover:text-primary hover:shadow-md active:scale-95 ${className}`.trim()}
