export default function HeroIllustration({ className = '', decorative = false }: { className?: string; decorative?: boolean }) {
  return (
    <svg
      ...
      aria-label={decorative ? undefined : 'Camino forestal con luz solar suave'}
      className={className}
    >
      <defs>
