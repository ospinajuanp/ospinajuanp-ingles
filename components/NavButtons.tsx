  ...
  return (
    <div className="mt-8 flex items-center justify-center gap-2 sm:gap-3">
      ...
      >
        ...
        <span className="text-sm font-medium text-base-content/60">/</span>
      ...
      <button
        ...
        title="Siguiente (→)"
        className="btn btn-primary inline-flex size-12 min-h-0 items-center justify-center rounded-full p-0 shadow-sm transition hover:-translate-y-0.5 active:scale-95 motion-reduce:transform-none disabled:opacity-40 disabled:hover:translate-y-0"
      >
      ...
      <button
        ...
        className="inline-flex size-12 items-center justify-center rounded-full border-2 border-primary/40 bg-base-100 text-primary shadow-sm transition hover:border-primary hover:bg-primary/10 hover:-translate-y-0.5 active:scale-95 motion-reduce:transform-none disabled:opacity-40 disabled:hover:translate-y-0 disabled:hover:bg-base-100"
      >
