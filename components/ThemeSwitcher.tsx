  ...
  return (
    <div className={`dropdown dropdown-end ${className}`.trim()}>
      <div
        ...
        className="inline-flex size-10 items-center justify-center rounded-full border border-base-300 bg-base-100 text-base-content shadow-sm transition hover:border-primary/40 hover:text-primary hover:shadow-md active:scale-95"
        ...
        {themes.map(({ id, label }) => {
          ...
          return (
            <li key={id}>
              ...
              >
                <RowIcon className="size-5 shrink-0" aria-hidden="true" />
